{
  ms-vscode = {
    ...
    remote-explorer = {
      version = "0.5.0";
      hash = "sha256-BNsnetpddxv3Y9MjZERU5jOq1I2g6BNFF1rD7Agpmr8=";
    };
    remote-server = {
      version = "1.5.3";
    ...
    remote-repositories = {
      version = "0.42.0";
      hash = "sha256-cYbkCcNsoTO6E5befw/ZN3yTW262APTCxyCJ/3z84dc=";
    };
    live-server = {
      version = "0.4.20";
      hash = "sha256-g+UuTmSKwX/ZgmHMOUHNEFuoeVoqU/F/1FAEcDcKOaY=";
    };
  };
  ms-vscode-remote = {
    remote-ssh = {
  ...
  ms-python = {
    python = {
      version = "2026.4.0";
      hash = "sha256-Q2HLvTzlzQkOEDkxYV/6FajRfgvjAD/4O3ki8W4fKyo=";
    };
    vscode-pylance = {
      version = "2026.3.1";
  ...
  redhat = {
    vscode-xml = {
      version = "0.29.3";
      hash = "sha256-QDFipVNXk7DRCmjnMjjPjM1g+qtpLHGOfEr8k6ztbCA=";
    };
    vscode-yaml = {
      version = "1.24.0";
  ...
  alexandar-djordjevic.gersemi-cmake-formatter = {
    version = "0.1.0";
    hash = "sha256-5XpsKjeCFY5rMc+k59jVvWLOrKUZUyE2Z844VmsmJVs=";
  };
  ...
  coopermaruyama.nix-embedded-languages = {
    version = "2.1.0";
    hash = "sha256-OSk/kEjz6SExQ527FOmujF9p4XMfcPxMt2Ky/re0Je8=";
  };
  kdl-org.kdl = {
    version = "2.1.3";
